...
| **Click-through** | mouse fora do gem | clique passa pro que está embaixo (estrutural, via `setIgnoreMouseEvents`) |
...
| Nome | Gatilho | O que faz |
|---|---|---|
| **zen_breathing** | assinatura do Zen (pose com prioridade, repetível) | facetas afastam e voltam em 3 respirações por ciclo de 4.6s, spin desacelera junto |
